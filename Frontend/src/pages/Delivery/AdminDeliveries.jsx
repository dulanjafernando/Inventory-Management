            ...
            <div className="bg-white border-b shadow-sm sticky top-0 z-10">
                <div className="px-8 py-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Assign deliveries to agents and monitor all delivery activities</p>
                    </div>
            ...
            <div className="px-8 py-6">
                        ...
                        <div className="flex gap-2">
                            {['All', 'Pending', 'In Transit', 'Delivered', 'Failed'].map(status => (
                                <button
                                    ...
                                    className={`px-3 py-2 rounded-lg text-sm font-medium transition ${statusFilter === status
                ...
                {loading ? (
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                        ...
                        <p className="text-gray-600 mb-4">No deliveries match your current filters.</p>
                        <button
                            onClick={handleOpenAssignModal}
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="bg-gray-50 border-b border-gray-200">
                                        <th className="text-left px-6 py-4 text-sm font-semibold text-gray-700">Agent</th>
                                        ...
                                        <th className="text-left px-6 py-4 text-sm font-semibold text-gray-700">Vehicle</th>
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {filteredDeliveries.map((delivery) => (
                                        <tr key={delivery.id} className="hover:bg-gray-50 transition">
                                            ...
                                            {/* Customer */}
                                            <td className="px-6 py-4">
                                                <p className="font-medium text-gray-900 text-sm">{delivery.Customer?.shopName}</p>
                                                <p className="text-xs text-gray-500">{delivery.Customer?.city}</p>
                                            </td>

                                            {/* Product */}
                                            <td className="px-6 py-4">
                                                <p className="text-sm text-gray-900">{delivery.productName}</p>
                                            </td>

                                            {/* Quantity */}
                                            <td className="px-6 py-4">
                                                <p className="text-sm text-gray-700">{delivery.quantity}</p>
                                            </td>
                                            ...
                                            {/* Vehicle */}
                                            <td className="px-6 py-4">
                                                <p className="text-sm text-gray-700">{delivery.vehicleId}</p>
                                            </td>
            ...
            {showAssignModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full mx-4 max-h-[90vh] overflow-y-auto">
                        {/* Header */}
                        <div className="flex items-center justify-between p-6 border-b bg-gradient-to-r from-blue-500 to-indigo-500 rounded-t-xl">
                            <div>
                        ...
                        <form onSubmit={handleAssignDelivery} className="p-6 space-y-5">
                            ...
                            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                                ...
                                {/* Product */}
                                <div className="mb-3">
                                    <label className="block text-xs font-medium text-purple-700 mb-1">Product</label>
                                    <select
                                ...
                                {/* Quantity */}
                                <div className="mb-3">
                                    <label className="block text-xs font-medium text-purple-700 mb-1">Quantity</label>
                                    <input
                                        type="text"
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-2 border border-purple-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-purple-100 font-semibold"
                                            min="0"
                                            step="0.01"
                                        />
                                    </div>
                            ...
                            {/* Notes */}
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-1">Notes / Instructions (Optional)</label>
                                <textarea
                            ...
                            {assignForm.vehicleId && assignForm.customerId && assignForm.productName && (
                                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                    <p className="text-sm font-semibold text-gray-800 mb-2">📋 Assignment Summary</p>
